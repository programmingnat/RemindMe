...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    private void sendNotification(String notificationDetails,List<Geofence>triggeringGeofences) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), ReminderListMain.class);
        ...
        notificationIntent.putExtra(GlobalConstants.INTENT_SOURCE,"GeofenceTransitionsIntentService");
        notificationIntent.putExtra(GlobalConstants.LIST_OF_TRIGGERED,tagsOfTriggered);
        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(ReminderListMain.class);
