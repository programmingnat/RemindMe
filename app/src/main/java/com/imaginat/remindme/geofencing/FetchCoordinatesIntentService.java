...
public class FetchCoordinatesIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String reminderID = intent.getStringExtra(GlobalConstants.CURRENT_TASK_ID);
        String listID = intent.getStringExtra(GlobalConstants.CURRENT_LIST_ID);
        String alarmTag = intent.getStringExtra(GlobalConstants.ALARM_TAG);
        ...
        String addressToLookup = intent.getStringExtra(GlobalConstants.LOCATION_DATA_EXTRA);
        ...
        if (addressToLookup == null) {
            ...
            deliverResultToReceiver(GlobalConstants.FAILURE_RESULT, null,alarmTag,reminderID,listID);
            return;
        }
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            deliverResultToReceiver(GlobalConstants.SUCCESS_RESULT, l,alarmTag,reminderID,listID);
        }
    }
    ...
    private void deliverResultToReceiver(int resultCode, Location location,String alarmTag,String reminderID,String listID) {
        ...
        bundle.putParcelable(GlobalConstants.RESULT_DATA_KEY, location);
        bundle.putString(GlobalConstants.ALARM_TAG,alarmTag);
        bundle.putString(GlobalConstants.CURRENT_TASK_ID,reminderID);
        bundle.putString(GlobalConstants.CURRENT_LIST_ID,listID);
