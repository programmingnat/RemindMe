...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        Log.d(TAG,"FetchAddressIntentService onHandleIntent called");
        String errorMessage = "";
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            Log.i(TAG, "address found"+addressFragments.get(0));
            deliverResultToReceiver(GlobalConstants.SUCCESS_RESULT,
